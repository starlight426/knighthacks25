...
class DQN(nn.Module):
    def __init__(self,LRate, IDimensions, F1Dimensions, F2Dimensions, n_actions):
        super(DQN,self).__init__()
        self.IDimensions = IDimensions
        self.F1Dimensions = F1Dimensions
        self.F2Dimensions = F2Dimensions
        self.n_actions = n_actions
        self.F1 = nn.Linear(*self.IDimensions, self.F1Dimensions)
        self.F2 = nn.Linear(self.F1Dimensions, self.F2Dimensions)
        self.F3 = nn.Linear(self.F2Dimensions, self.n_actions)
...
class Agent():
    def __init__(self, G, E, LRate, IDimensions, BSize, n_actions,
