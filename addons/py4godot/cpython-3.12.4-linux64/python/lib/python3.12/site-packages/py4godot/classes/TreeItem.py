...
class TreeItem(py4godot_object.Object):
  ...
  @functools.native_method
  def get_custom_font(self, column:'int'   ) -> typing.Union['py4godot_font.Font','py4godot_systemfont.SystemFont','py4godot_fontfile.FontFile','py4godot_fontvariation.FontVariation']:
    r'''
